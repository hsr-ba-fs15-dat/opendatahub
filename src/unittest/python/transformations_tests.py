...
file_in = nodes.FileInput(TestBase.get_test_file_path('test-addresses.csv'))
csv_in = nodes.CsvInput()

file_in_2 = nodes.FileInput(TestBase.get_test_file_path('test-addresses2.csv'))
