...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'app/scripts/main/controllers/odhql.controller.js',
      'app/scripts/main/controllers/odhql.detail.controller.js',
      ...
      'app/scripts/main/controllers/transformation.controller.js',
