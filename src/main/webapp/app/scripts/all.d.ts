...
/// <reference path='main/controllers/odhql-console.ts' />
/// <reference path='main/controllers/offer.controller.ts' />
/// <reference path='main/controllers/package.controller.ts' />
...
/// <reference path='main/directives/pagination.ts' />
...
/// <reference path='main/services/package.service.ts' />
...
/// <reference path='utils/confirmation.controller.ts' />
